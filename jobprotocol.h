...
int buffer_msg(int, char *);
int splitWords(char *, char *[]);
void list_jobs(JobList *, Client);
void find_str(char *, char []);
void clean_exit(int, Client *, JobList *, int);
void write_to_client(JobNode *, Client *, int);
int read_buf(int, Client *, JobList *);
 ...
 */
JobNode *start_job(char *, char*[], int);
